    ...
    public static function groups(): array
    {
        return [
            ...
            'Reportes' => [
                ...
                'reports.income_statement' => 'Ver Estado de Resultados Integral (P&G)',
                'reports.balance_sheet' => 'Ver Estado de Situación Financiera (Balance General)',
                'reports.financial_indicators' => 'Ver Indicadores Financieros',
    ...
    public static function defaultForRole(string $role): array
    {
        ...
        return match ($role) {
            ...
            'accountant' => [
                ...
                'reports.income_statement', 'reports.balance_sheet', 'reports.financial_indicators',
