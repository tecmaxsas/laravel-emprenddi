...
class AccountsPayablePage extends Page implements HasForms, HasTable
{
    ...
    public function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Section::make('Filtros')
                ->columns(4)
                ->schema([
                    Forms\Components\DatePicker::make('as_of')->label('Corte a')->required()->live(),
                    ...
                    Forms\Components\Toggle::make('only_overdue')->label('Solo vencidas')->live(),
                    Forms\Components\Toggle::make('include_paid')->label('Incluir pagadas')->live(),
                ]),
        ])->statePath('filters');
    }
        ...
        return $table
            ->query(function () {
                ...
                return PurchaseInvoice::query()
                    ...
                    ->whereDate('date', '<=', $asOf)
                    ->when(! ($this->filters['include_paid'] ?? false), fn (Builder $q) => $q
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('supplier_invoice_number')->label('N° prov.')->placeholder('—')->toggleable(),
                Tables\Columns\TextColumn::make('supplier.name')->label('Proveedor')->wrap(),
                ...
                Tables\Columns\TextColumn::make('days_overdue')
                    ->label('Días vencido')
                    ->state(function (PurchaseInvoice $r) {
