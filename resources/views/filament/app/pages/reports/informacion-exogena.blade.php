    ...
    @if ($generated)
        ...
        <div style="margin-top:20px; border:1px solid #e5e7eb; border-radius:10px; overflow:hidden; background:#fff;">
            ...
            @else
                ...
                <div style="padding:12px 16px; font-size:11px; color:#94a3b8; border-top:1px solid #e5e7eb;">
                    Reporte de revisión. La exportación al formato Excel del prevalidador DIAN
                    (con topes de cuantías mínimas y columnas oficiales) se entrega en la siguiente iteración.
                </div>
            @endif
        </div>
    @endif
