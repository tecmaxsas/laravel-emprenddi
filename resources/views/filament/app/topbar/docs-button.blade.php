{{-- Botón "Ayuda" en el topbar del panel App. Abre el centro de
     documentación pública (emprenddi.com/docs/) en una pestaña nueva.
     No requiere sesión — el sitio de docs es publico. --}}
<a
    href="https://emprenddi.com/docs/"
    target="_blank"
    ...
    title="Abrir centro de ayuda en nueva pestaña"
>
